...
public class ModEntities
{
    ...
    public static final RegistryObject<EntityType<GrenadeEntity>> DYNAMITE = registerBasic("dynamite", GrenadeEntity::new);
    public static final RegistryObject<EntityType<ThrowableGrenadeEntity>> THROWABLE_DYNAMITE = registerBasic("throwable_dynamite", ThrowableGrenadeEntity::new);
