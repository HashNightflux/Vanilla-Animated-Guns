...
public abstract class Attachment
{
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            {
                event.getToolTip().add(Component.translatable("perk.vag.title").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
            ...
            {
                addPerk(negativePerks, false, "perk.vag.fire_volume.negative");
            }
            else if(outputSound < inputSound)
            {
                addPerk(positivePerks, true, "perk.vag.fire_volume.positive");
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                ...
                {
                    addPerk(positivePerks, true, "perk.vag.silenced.positive");
                    break;
                }
            }
            ...
            {
                addPerk(negativePerks, false, "perk.vag.sound_radius.negative");
            }
            else if(outputRadius < inputRadius)
            {
                addPerk(positivePerks, true, "perk.vag.sound_radius.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.vag.additional_damage.positive", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            else if(additionalDamage < 0.0F)
            {
                addPerk(negativePerks, false, "perk.vag.additional_damage.negative", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            ...
            {
                addPerk(positivePerks, true, "perk.vag.modified_damage.positive");
            }
            else if(outputDamage < inputDamage)
            {
                addPerk(negativePerks, false, "perk.vag.modified_damage.negative");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.vag.projectile_speed.positive");
            }
            else if(outputSpeed < inputSpeed)
            {
                addPerk(negativePerks, false, "perk.vag.projectile_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.vag.projectile_spread.negative");
            }
            else if(outputSpread < inputSpread)
            {
                addPerk(positivePerks, true, "perk.vag.projectile_spread.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.vag.projectile_life.positive");
            }
            else if(outputLife < inputLife)
            {
                addPerk(negativePerks, false, "perk.vag.projectile_life.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.vag.recoil.negative");
            }
            else if(outputRecoil < inputRecoil)
            {
                addPerk(positivePerks, true, "perk.vag.recoil.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.vag.ads_speed.positive");
            }
            else if(outputAdsSpeed < inputAdsSpeed)
            {
                addPerk(negativePerks, false, "perk.vag.ads_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.vag.rate.negative");
            }
            else if(outputRate < inputRate)
            {
                addPerk(positivePerks, true, "perk.vag.rate.positive");
            }
    ...
    {
        components.add(Component.translatable(positive ? "perk.vag.entry.positive" : "perk.vag.entry.negative", Component.translatable(id, params).withStyle(ChatFormatting.WHITE)).withStyle(positive ? ChatFormatting.DARK_AQUA : ChatFormatting.GOLD));
    }
}
