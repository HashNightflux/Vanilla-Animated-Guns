...
public class GunItem extends Item implements IMeta
{
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flag)
    {
        ...
        if(ammo != null)
        {
            tooltip.add(Component.translatable("info.vag.ammo_type", Component.translatable(ammo.getDescriptionId()).withStyle(ChatFormatting.WHITE)).withStyle(ChatFormatting.WHITE));
        }
        ...
        tooltip.add(Component.translatable("info.vag.damage", ChatFormatting.DARK_GREEN + ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(damage) + additionalDamageText).withStyle(ChatFormatting.DARK_GREEN));

        if(tagCompound != null)
        {
            if(tagCompound.getBoolean("IgnoreAmmo"))
            {
                tooltip.add(Component.translatable("info.vag.ignore_ammo").withStyle(ChatFormatting.AQUA));
            }
            else
            {
                int ammoCount = tagCompound.getInt("AmmoCount");
                tooltip.add(Component.translatable("info.vag.ammo", ChatFormatting.DARK_GREEN.toString() + ammoCount + "/" + GunEnchantmentHelper.getAmmoCapacity(stack, modifiedGun)).withStyle(ChatFormatting.DARK_GREEN));
            }
        }
