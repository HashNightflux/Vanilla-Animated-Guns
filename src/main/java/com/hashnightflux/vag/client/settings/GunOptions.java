package com.hashnightflux.vag.client.settings;
...
public class GunOptions
{
    ...
    /*public static final ProgressOption ADS_SENSITIVITY = new GunSliderPercentageOption("vag.options.adsSensitivity", 0.0, 1.0, 0.01F, gameSettings -> {
        ...
        return Component.translatable("vag.options.adsSensitivity.format", FORMAT.format(adsSensitivity));
    });

    public static final CycleOption<ResourceLocation> CROSSHAIR = CycleOption.create("vag.options.crosshair", () -> {
    ...
    /*public static final Option CROSSHAIR = CycleOption.create("vag.options.crosshair", () -> {
