...
{
    public static final KeyMapping KEY_RELOAD = new KeyMapping("key.vag.reload", GLFW.GLFW_KEY_R, "key.categories.vag");
    public static final KeyMapping KEY_UNLOAD = new KeyMapping("key.vag.unload", GLFW.GLFW_KEY_U, "key.categories.vag");
