package com.hashnightflux.vag.client.util;
...
import com.hashnightflux.vag.cache.ObjectCache;
...
public final class PropertyHelper
{
    ...
    public static final String MODEL_KEY = "vag:model";
    public static final String WEAPON_KEY = "vag:weapon";
    public static final String SCOPE_KEY = "vag:scope";
    public static final String BARREL_KEY = "vag:barrel";
